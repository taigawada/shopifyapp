 ...
 *
 */
export type Collection = HasMetafields & HasPublishedTranslations & Node & Publishable & {
 ...
 *
 */
export type Customer = CommentEventSubject & HasEvents & HasMetafields & LegacyInteroperability & Node & {
  __typename?: 'Customer';
...
export type DiscountAutomaticNode = HasEvents & Node & {
...
export type DiscountCodeNode = HasEvents & Node & {
 ...
 *
 */
export type DraftOrder = CommentEventSubject & HasEvents & HasLocalizationExtensionsForDraftOrders & HasMetafields & LegacyInteroperability & Node & {
 ...
 *
 */
export type Location = LegacyInteroperability & Node & {
  __typename?: 'Location';
...
export type MetafieldInput = {
  ...
  valueType?: InputMaybe<MetafieldValueType>;
};
...
export type MutationKitSkillTriggerRequestArgs = {
  ...
  placeholders?: InputMaybe<Scalars['JSON']>;
};
...
export type MutationPaymentsAppConfigureArgs = {
  externalHandle?: InputMaybe<Scalars['String']>;
  ready: Scalars['Boolean'];
};
...
export type Order = CommentEventSubject & HasEvents & HasLocalizationExtensions & HasMetafields & LegacyInteroperability & Node & {
  __typename?: 'Order';
  /**
...
export type PaymentSessionRejectionReasonInput = {
  ...
  merchantMessage?: InputMaybe<Scalars['String']>;
};
...
export type PaymentSessionStatus = {
  ...
  /** The payment status reason (if any). */
...
export type Product = HasMetafields & HasPublishedTranslations & LegacyInteroperability & Navigable & Node & OnlineStorePreviewable & Publishable & {
  __typename?: 'Product';
  /** The number of publications a resource is published to without feedback errors. */
  availablePublicationCount: Scalars['Int'];
  /**
...
export type ProductVariant = HasMetafields & HasPublishedTranslations & LegacyInteroperability & Navigable & Node & {
...
/**
 * Represents the type of pricing associated to the selling plan (for example, a $10 or 20% discount that recurs
...
export type ShopUploadedImagesArgs = {
  ...
  reverse?: InputMaybe<Scalars['Boolean']>;
  scale?: InputMaybe<Scalars['Int']>;
  sortKey?: InputMaybe<ShopImageSortKeys>;
};
...
export type GetFirstFiveOrdersQueryVariables = Exact<{ [key: string]: never; }>;


export type GetFirstFiveOrdersQuery = { __typename?: 'QueryRoot', orders: { __typename?: 'OrderConnection', edges: Array<{ __typename?: 'OrderEdge', node: { __typename?: 'Order', id: string } }> } };
...
export const GetFirstFiveOrdersDocument = gql`
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    getFirstFiveOrders(variables?: GetFirstFiveOrdersQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetFirstFiveOrdersQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetFirstFiveOrdersQuery>(GetFirstFiveOrdersDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getFirstFiveOrders', 'query');
    },
